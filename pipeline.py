...
LUA_SHA1 = get_hash(os.path.join(CWD, 'mixer.lua'))
...
project = Project(
    title = 'Mixer',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://www.archiveteam.org/images/d/d9/Mixer-logo.png" height="50px"/>
    <h2>mixer.com <span class="links"><a href="https://mixer.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/mixer/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='mixer'),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
